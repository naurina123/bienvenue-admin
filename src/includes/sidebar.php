<div class="left-sidenav">
            ...
            <div class="brand">
                <a href="dashboard/crm-index.html" class="logo">
                    ...
                    <!-- <span>
                        <img src="assets/images/bienvenue-logo.svg" alt="logo-large" class="logo-lg logo-light">
                        <img src="assets/images/bienvenue-logo.svg" alt="logo-large" class="logo-lg logo-dark">
                    </span> -->
                </a>
            </div>
            <!--end logo-->
            <div class="menu-content h-100" data-simplebar>
                <ul class="metismenu left-sidenav-menu">
                    ...
                    <div class="button-items"> 
                        <button type="button" class="btn btn-outline-warning waves-effect waves-light"><span><i data-feather="plus-circle" class="align-self-center menu-icon px-1"></i></span>Create Product</button>
                    </div>
                    </li>
                    <hr class="hr-dashed hr-menu">
                    <li class="menu-label mt-0">Dashboard</li>
                    <li class="nav-item"><a class="nav-link" href="index.php"><i data-feather="home" class="align-self-center menu-icon"></i>Dashboard</a></li>
                    <li>
                        <a href="javascript: void(0);"><i data-feather="grid" class="align-self-center menu-icon"></i><span class="text-dark">Setup</span><span class="menu-arrow"><i class="mdi mdi-chevron-right"></i></span></a>
                        <ul class="nav-second-level" aria-expanded="false">
                            <li class="nav-item"><a class="nav-link" href="categories.php"><i class="ti-control-record"></i>Categories</a></li>
                            <li class="nav-item"><a class="nav-link" href="merchantapproval.php"><i class="ti-control-record"></i>Merchant</a></li>
                    ...
                    <!-- <li class="nav-item"><a class="nav-link" href="advertising.php">
                        <a href="javascript: void(0);"><i data-feather="grid" class="align-self-center menu-icon"></i><span>Advertising</span><span class="menu-arrow"><i class="mdi mdi-chevron-right"></i></span></a> -->
                        <!-- <ul class="nav-second-level" aria-expanded="false">
                            <li>

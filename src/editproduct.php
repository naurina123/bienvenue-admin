                     ...
                     <form>
                        <div class="form-row">
                           <div class="col-md-6 mb-3">
                              ...
                              <input type="text" class="form-control " id="validationServer01" placeholder="Product Name" value="Salt n Pepper" required="">
                           ...
                           <div class="col-md-6 mb-3">
                              ...
                              <!-- is-valid -->
                              <input type="text" class="form-control " id="validationServer01" placeholder="Product Code" value="24234" required="">
                              <!-- <div class="valid-feedback">
                                 Looks good!
                                 </div> -->
                           </div>
                        ...
                        <div class="col-md-6">
                              ...
                              <input type="text" class="form-control " id="validationServer01" placeholder="$4566/-" value="$4566/-" required="">
                              <div class="valid-feedback">
                                 Looks good!
                              </div>
                           </div>
                        ...
                        <div class="form-row">
                           <div class="col-md-6 mb-3">
                              ...
                              <!-- is-valid -->
                              <textarea type="text" class="form-control " id="validationServer01" placeholder="Pizza with extra cheese topping,Pepperoni" value="Pizza with extra cheese topping,Pepperoni" required=""></textarea>
                              <!-- <div class="valid-feedback">
                                 Looks good!
                                 </div> -->
                           </div>
